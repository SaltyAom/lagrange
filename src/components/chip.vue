...
<template>
	<RadioGroupItem
		:value="props.value"
		class="text-slate-500 px-1 py-0.25 interact:bg-violet-500/10 interact:text-violet-500/90 border border-transparent interact:border-violet-500/15 rounded-full transition-colors outline-none ring-0 cursor-pointer capitalize highlight-focus"
		:id="props.id"
		:class="{
